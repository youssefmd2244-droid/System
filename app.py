...
# =====================================================================
# 0. التثبيت التلقائي للمكتبات والاعتمادات من داخل الكود (Auto-Installer)
# =====================================================================
...
# =====================================================================
# 1. واجهة المستخدم الرسومية للموقع (Streamlit UI)
# =====================================================================
...
# مدخلات إعدادات الحسابات والـ API
...
# =====================================================================
# 2. كلاسات المعالجة والإنتاج والنشر
# =====================================================================
class VideoGenerator:
    ...
    def create_script(self):
        st.info("🤖 جاري كتابة السكريبت بالذكاء الاصطناعي...")
    ...
    def create_images(self):
        ...
        st.success("🖼️ تم توليد الصور والمشاهد!")

    def render_video(self):
        st.info("🎬 جاري مونتاج ودمج الفيديو النهائي...")
        ...
        st.success("🔥 تم إنتاج الفيديو النهائي بنجاح!")
...
class AutoPublisher:
    ...
    def publish_to_instagram(self):
        ...
        try:
            ...
            st.success("✓ تم النشر على انستجرام بنجاح!")
        except Exception as e:
            st.error(f"خطأ انستجرام: {e}")

    def publish_to_tiktok(self):
        st.info("🎵 جاري فتح المتصفح الوهمي للنشر على تيك توك...")
        ...
        with sync_playwright() as p:
            ...
            if os.path.exists(cookies_file):
                ...
                st.warning("⚠️ يتطلب تيك توك ملف كوكيز تسجيل الدخول (tiktok_auth.json) للعمل على السيرفر.")
                return
            ...
            post_button.click()
            time.sleep(5)
            st.success("✓ تم النشر على تيك توك بنجاح!")
            browser.close()

# =====================================================================
# 3. زر تشغيل المنظومة (Execution Trigger)
# =====================================================================
if st.button("🚀 ابدأ صناعة ونشر الفيديو الآن", type="primary"):
    if not GEMINI_API_KEY:
        st.error("الرجاء إدخال Gemini API Key أولاً في القائمة الجانبية!")
    else:
        # تشغيل الإنتاج
        ...
        # عرض الفيديو داخل الموقع للمعاينة
        st.subheader("📺 معاينة الفيديو المنتج:")
        st.video(generator.output_video_path)
        
        # النشر
        tags = f"#{category} #AI #trending {custom_tags}"
        final_caption = f"محتوى حصري صُنع بالذكاء الاصطناعي 🎬🔥 \n {tags}"
        
        st.subheader("📤 حالة النشر التلقائي:")
